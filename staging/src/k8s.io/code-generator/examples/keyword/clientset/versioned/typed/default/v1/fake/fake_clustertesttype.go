...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *defaultv1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clustertesttypesResource, name), &defaultv1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*defaultv1.ClusterTestType), err
}

// List takes label and field selectors, and returns the list of ClusterTestTypes that match those selectors.
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *defaultv1.ClusterTestTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clustertesttypesResource, clustertesttypesKind, opts), &defaultv1.ClusterTestTypeList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &defaultv1.ClusterTestTypeList{ListMeta: obj.(*defaultv1.ClusterTestTypeList).ListMeta}
	for _, item := range obj.(*defaultv1.ClusterTestTypeList).Items {
...
func (c *FakeClusterTestTypes) Create(ctx context.Context, clusterTestType *defaultv1.ClusterTestType, opts v1.CreateOptions) (result *defaultv1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clustertesttypesResource, clusterTestType), &defaultv1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*defaultv1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) Update(ctx context.Context, clusterTestType *defaultv1.ClusterTestType, opts v1.UpdateOptions) (result *defaultv1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clustertesttypesResource, clusterTestType), &defaultv1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*defaultv1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *defaultv1.ClusterTestType, opts v1.UpdateOptions) (*defaultv1.ClusterTestType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clustertesttypesResource, "status", clusterTestType), &defaultv1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*defaultv1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(clustertesttypesResource, name), &defaultv1.ClusterTestType{})
	return err
}
...
func (c *FakeClusterTestTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &defaultv1.ClusterTestTypeList{})
	return err
}

// Patch applies the patch and returns the patched clusterTestType.
func (c *FakeClusterTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *defaultv1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustertesttypesResource, name, pt, data, subresources...), &defaultv1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*defaultv1.ClusterTestType), err
